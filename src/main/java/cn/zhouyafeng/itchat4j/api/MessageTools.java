...
public class MessageTools {
     ...
     * @param remarkName
     * @author wangtan
     * @date 2019-12-04 14:23:11
     */
    public static boolean sendMsgByRemarkName(String text, String remarkName) {
        if (remarkName != null) {
            String toUserName = WechatTools.getUserNameByRemarkName(remarkName);
            if (toUserName != null) {
                webWxSendMsg(1, text, toUserName);
                return true;
            }
     ...
     * @author wangtan
     * @date 2019-12-04 14:27:51
     */
    public static boolean sendMsgByGroupName(String text, String groupName) {
        if (groupName != null) {
            String toUserName = WechatTools.getGroupNameByNickName(groupName);
            if (toUserName != null) {
                webWxSendMsg(1, text, toUserName);
                return true;
            }
